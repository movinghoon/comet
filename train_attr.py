...
from new_dataset import Cars3D, Shapes3D, MPI3D
...
def parse_args():
    ...
    parser.add_argument('--n_slots', default=10, type=int, help='number of components to explain an image with')
    parser.add_argument('--dataset', default='clevr_easy', type=str, help='Dataset to use (intphys or others or imagenet or cubes)')
    
    parser.add_argument('--batch_size', default=12, type=int, help='size of batch of input to use')
...
DATA_PATH = {
    ...
    'car3d':'/data1/common_datasets/cars3d',
    'mpi3d':'/data1/common_datasets/mpi3d/toy',
    'shape3d':'/data1/common_datasets/shapes3d',
}
